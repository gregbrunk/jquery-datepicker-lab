...
function daysLeft() {
    ...
    userEvent = $(".endDate").val();

    if(diffDays < 0) {
    	resultString = "This day is in the past, idiot!";
    } else if (diffDays == 0) {
    	resultString = (userEvent + " is tomorrow!");
    } else { 
    	resultString = ("You have " + diffDays + " days left until " + userEvent + ".");
    }
}
